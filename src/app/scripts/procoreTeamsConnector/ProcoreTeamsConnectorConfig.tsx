...
export interface IProcoreTeamsConnectorConfigState extends ITeamsBaseComponentState {
...
export interface IProcoreTeamsConnectorConfigProps {
}
...
/**
 * Implementation of the procoreTeamsConnector Connector connect page
 */
export class ProcoreTeamsConnectorConfig extends TeamsBaseComponent<IProcoreTeamsConnectorConfigProps, IProcoreTeamsConnectorConfigState> {
        ...
        if (await this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/procoreTeamsConnector/config.html`,
